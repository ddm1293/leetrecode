...
@injectable()
export class ArchiveSubmissionHandler implements LambdaInterface {
...
const handlerInstance: ArchiveSubmissionHandler = container.resolve(ArchiveSubmissionHandler)
export const archiveSubmissionHandler = handlerInstance.handler.bind(handlerInstance);
